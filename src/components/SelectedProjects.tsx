...
const projects = [
    {
        ...
        description: "Optimized inventory management with 40% faster data retrieval.",
        image: "/images/project_ecommerce_dashboard_1767092688844.png",
    ...
    {
        title: "Aurum SaaS",
        description: "Enterprise analytic platform processing 1M+ data points daily.",
        image: "/images/project_saas_platform_1767092706017.png",
    ...
    },
    {
        ...
        description: "Real-time financial tracking with bank-grade security protocols.",
            ...
            <div className="max-w-8xl mx-auto px-6 md:px-24 w-full grid grid-cols-1 lg:grid-cols-[30%_70%] gap-12 lg:gap-24 items-start">
                ...
                <div className="lg:sticky lg:top-32 space-y-6 md:space-y-8">
                    ...
                    <p className="fade-in-text text-silver/60 text-lg md:text-xl font-light leading-relaxed max-w-sm">
                        Showcasing real-world, production-ready work focused on solving complex problems with clean code.
                    </p>
                ...
                <div className="relative group/scroll">
                    ...
                    >
                        {projects.map((project, index) => (
                            <div
                                key={index}
                                className="project-card min-w-[300px] md:min-w-[450px] aspect-[3/4] group relative rounded-[2rem] overflow-hidden bg-white/[0.03] border border-white/5 snap-start transition-all duration-500 hover:border-white/20 hover:shadow-2xl hover:shadow-emerald-500/5"
                            >
                                {/* Image Overlay */}
                                <div className="absolute inset-0 z-0">
                                    ...
                                    />
                                    {/* Gradient Mask */}
                                    <div className="absolute inset-0 bg-gradient-to-t from-bgBlack via-bgBlack/40 to-transparent z-10" />
                                </div>
                                ...
                                <div className="absolute inset-0 z-20 p-8 md:p-12 flex flex-col justify-end items-start gap-4 md:gap-6">
                                    ...
                                    <div className="space-y-2 transform transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                                        ...
                                        <p className="text-silver/50 text-sm md:text-base leading-relaxed max-w-[280px] md:max-w-xs group-hover:text-silver/80 transition-colors">
                                            {project.description}
                                        </p>
                                    </div>
