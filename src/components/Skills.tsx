...
const skillDomains = [
    {
        ...
        description: "Building performance-first, accessible, and scalable user interfaces.",
        skills: ["HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "React.js", "Next.js"],
    },
    {
        title: "Backend & Data",
        description: "Designing secure architectures and managing data across SQL and NoSQL ecosystems.",
        skills: ["Node.js", "Express.js", "RESTful APIs", "MongoDB", "PostgreSQL", "JWT / OAuth"],
    },
    {
        title: "UI, Motion & Styling",
        description: "Crafting immersive digital experiences through precision styling and fluid animations.",
        skills: ["Tailwind CSS", "GSAP", "Bootstrap", "Responsive Design", "Motion Design"],
    },
    {
        title: "Tooling & Workflow",
        description: "Maintaining a disciplined development process through version control and collaborative testing.",
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                ...
                <header className="skills-header mb-20 md:mb-32 max-w-3xl">
                    ...
                    <p className="text-silver/60 text-lg md:text-xl font-light leading-relaxed">
                        I specialize in building production-ready applications with a focus on maintainability, performance, and user experience.
                    </p>
                </header>
                ...
                <div className="skills-grid grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10 overflow-hidden">
                    {skillDomains.map((domain, index) => (
                        <div
                            key={index}
                            className="skill-card group bg-bgBlack p-8 md:p-12 lg:p-16 hover:bg-white/[0.02] transition-colors duration-500"
                        >
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-3">
                                {domain.skills.map((skill, sIndex) => (
                                    <div key={sIndex} className="flex items-center gap-2 group/skill">
